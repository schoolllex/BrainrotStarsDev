...
const REBIRTH_TIERS = [
    {
        ...
        costLabel: "1B",
        rewards: [
            { type: "cps", value: "+5% CPS global" },
            { type: "chest-mythique", value: "+50K 💰", goldReward: 50_000 }
        ]
    },
    {
        id: 2,
        ...
        rewards: [
            { type: "cps", value: "+5% CPS global" },
            { type: "chest-mythique", value: "+70K 💰", goldReward: 70_000 }
        ]
    },
    {
        id: 3,
        ...
        rewards: [
            { type: "cps", value: "+5% CPS global" },
            { type: "chest-mythique", value: "+100K 💰", goldReward: 100_000 }
        ]
    },
    {
        id: 4,
        ...
        rewards: [
            { type: "cps", value: "+5% CPS global" },
            { type: "chest-mythique", value: "+120K 💰", goldReward: 120_000 }
    ...
    },
    {
        ...
        rewards: [
            { type: "cps", value: "+5% CPS global" },
            { type: "chest-mythique", value: "+150K 💰", goldReward: 150_000 }
        ]
    }
];
...
function bindEvents() {
    ...
    ui.modalConfirm?.addEventListener("click", async () => {
        ...
        const goldReward = typeof payload.goldReward === "number" ? payload.goldReward : (tier.rewards.find(r => r.goldReward)?.goldReward || 0);
        setEconomySnapshot(goldReward, economyState.coinPerSec);
        closeConfirmModal();
